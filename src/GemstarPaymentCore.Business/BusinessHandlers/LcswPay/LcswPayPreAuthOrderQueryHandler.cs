...
namespace GemstarPaymentCore.Business.BusinessHandlers.LcswPay
{
    ...
    public class LcswPayPreAuthOrderQueryHandler : IBusinessHandler
    {
        ...
        public LcswPayPreAuthOrderQueryHandler(ILogger<LcswPayQueryHandler> log, ILcswPayClient client, IOptionsSnapshot<LcswPayOption> options)
        {
            _log = log;
            _client = client;
        ...
        public async Task<HandleResult> HandleBusinessContentAsync()
        {
            ...
            try
            {
                ...
                //调用查询接口
                var request = new LcswPayPreAuthOrderQueryRequest
                {
                    PayType = payType,
