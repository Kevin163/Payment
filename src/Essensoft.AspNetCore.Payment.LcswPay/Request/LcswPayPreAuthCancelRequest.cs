...
namespace Essensoft.AspNetCore.Payment.LcswPay.Request
{
    ...
    /// 利楚商务扫呗预授权撤销请求
    /// </summary>
    public class LcswPayPreAuthCancelRequest : ILcswPayResquest<LcswPayPreAuthCancelResponse>
    {
        public LcswPayPreAuthCancelRequest()
        {
            PayVersion = "110";
            ServiceId = "016";
        }
        ...
        {
            return "/pos/200/preauth/preAuthCancel";
        }
