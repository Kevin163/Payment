...
namespace GemstarPaymentCore.Payment.ChinaumsPay
{
    ...
    /// 银商支付字典
    /// </summary>
    public class ChinaumsPayDictionary : SortedDictionary<string, string>
    {
        public ChinaumsPayDictionary() { }

        public ChinaumsPayDictionary(IDictionary<string, string> dictionary)
            : base(dictionary)
        { }
